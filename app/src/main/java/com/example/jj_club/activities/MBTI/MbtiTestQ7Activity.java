...
public class MbtiTestQ7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mbti_test_q7);
        ...
        btnLogin1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MbtiTestQ7Activity.this, MbtiTestQ8Activity.class);
